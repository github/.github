...
If the repository is eligible for rewards, you can submit a report via [HackerOne](https://hacker-one.com). You can find more useful information in our [rules](https://bounty.github.com/#rules) and [FAQ](https://bounty.github.com/#faqs).
